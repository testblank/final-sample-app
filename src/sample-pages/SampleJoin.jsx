...
import { BaseInput, EmailInput, MeasureInput, SecretInput } from '@components/TextInput';
...
const SampleJoin = ({ history, location, match, staticContext }) => {
	...
	const popupRender = () => (
		<Popup
			titleStr={'중복확인'}
			messageStr={idConfirm ? '사용가능한 아이디 입니다.' : '아이디를 다시 입력해 주세요'}
			btnQuantity={1}
			firstBtnStr={'확인'}
	...
	const bodyRender = () => (
		<div className={'SampleJoinBody flex flex-col text-left px-4 pt-4'}>
			...
			<div className={'text-xs text-gray-400'}>
                입력하신 정보는 서울시설공단에서 보관하며, 티머니GO에서는 별도로 보유하지 않습니다.
			</div>
